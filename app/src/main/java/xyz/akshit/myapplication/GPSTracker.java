...
public class GPSTracker extends Service implements LocationListener {
    ...
    public GPSTracker(){
        mContext = mActivity;
        gps_c = (GPScoordinates) mContext;
        getLocation();
    }

    public GPSTracker(Context context) {
        gps_c = (GPScoordinates) context;
                ...
                if (isNetworkEnabled) {
                    ...
                    if (locationManager != null) {
                        ...
                        if (location != null) {
                            ...
                            gps_c.sendCoordinates(latitude,longitude);
                        }
                    }
                }
    ...
    public void onLocationChanged(Location location) {
        ...
        gps_c.sendCoordinates(lat,longi);
